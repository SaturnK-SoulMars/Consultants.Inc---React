...
const HeroSection = () => {
  return (
    <section className="text-[#FFFFFF] relative w-full h-screen overflow-hidden">
      <CursorBlob/>
      {/* Background image */}
      ...
      {/* Subtitle */}
      <div className="absolute right-12 top-[45%] max-w-[240px]">
      ...
      <div className="absolute bottom-12 left-8 right-8">
        <h1 className="hero-title text-[clamp(3rem,10vw,10rem)] leading-12 sm:leading-36">
          Outsource<br />
          Consultants, Inc.
        </h1>
      </div>
